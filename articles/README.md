...
- `YYYY-MM-DD-<slug>.post.txt`（v2以降） — POST_TITLE/POST_BODY/TAGS/SNS_TEXT/SOURCE/HEADER_IMAGE_PROMPT/CATEGORY/SCHEDULE/QUALITY_SCORE形式の投稿データ＋A/B/C最終判定。HEADER_IMAGE_PROMPTは`.image-prompt.txt`と同内容で、コピペ1回で本文と一緒に見出し画像の依頼文も使えるようにしたもの
...
- `2026-week-2026-09-13-plan.md` — 2026-09-13〜09-19の週間分（21本）の候補スコアリングと日程割り当てのまとめ
- `2026-week-2026-09-20-plan.md` — 2026-09-20〜09-26の週間分（21本）の候補スコアリングと日程割り当てのまとめ（前週のアクセス分析を反映）
